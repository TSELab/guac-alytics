...
# plot1
    ...
    plt.ylabel('values')
    plt.title('In-degree Statistical measures(log) for all source architectures')
    plt.xticks(days)
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/stat_in.png')
    plt.close()
...
#plot2
    ...
    plt.title('Max In-degree tracking for all source architectures')
    plt.xticks(days)
    plt.legend(loc='best')
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/max_in.png')
    plt.close()
...
#plot3
    ...
    plt.title('Mean In-degree and Std. deviation for all source architectures')
    plt.xticks(days)
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/mean_in.png')
    plt.close()
...
# plot4
    ...
    plt.xticks(days)
    plt.savefig('/data/yellow/vineet/results/plots/std_in.png',dpi=1200)
    plt.close()
