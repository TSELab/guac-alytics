...
# plot1
    ...
    plt.ylabel('values')
    plt.title('Out-degree Statistical measures(log) for amd64 architectures')
    plt.xticks(days)
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/stat_amd64_out(17-22).png')
    plt.close()
...
#plot2
    ...
    plt.title('Max out-degree tracking for amd64 architectures')
    plt.xticks(days)
    plt.legend(loc='best')
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/max_amd64_out(17-22).png')
    plt.close()
...
#plot3
    ...
    plt.title('Mean out-degree and Std. deviation for amd64 architectures')
    plt.xticks(days)
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/mean_amd64_out(17-22).png')
    plt.close()
...
# plot4
    ...
    plt.title('Std. deviation (log) for amd64 architectures')
    plt.xticks(days)
    plt.savefig('/data/yellow/vineet/results/plots/std_amd64_out(17-22).png',dpi=1200)
    plt.close()
