...
def plot_statistics():
    ...
    plt.ylabel('values')
    plt.title('Statistical measures(log)')
    plt.xticks(days)
    plt.savefig('/data/yellow/vineet/results/plots/stat_in(17-22).png',dpi=1200)
    plt.close()
    ...
    plt.xticks(days)
    plt.savefig('/data/yellow/vineet/results/plots/std_in(17-22).png',dpi=1200)
    plt.close()
    ...
    plt.xticks(days)
    plt.tight_layout()
    plt.savefig('/data/yellow/vineet/results/plots/mean_in(17-22).png')
    plt.close()
    ...
    plt.xticks(days)
    plt.legend(loc='best')
    plt.savefig('/data/yellow/vineet/results/plots/max_in(17-22).png')
    plt.close()
