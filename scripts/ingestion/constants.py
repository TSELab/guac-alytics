...
MAINTAINER_TEXT_FILE = '/data/yellow/vineet/python_files/new_scripts/database_creation/maintainer.txt'
MAINTAINER_CSV_FILE = '/data/yellow/vineet/python_files/new_scripts/database_creation/maintainer.csv'
REGEX = "(\ )+"
